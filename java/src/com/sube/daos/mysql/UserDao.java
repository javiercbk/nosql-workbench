...
public interface UserDao {
	public Long createUser(User user, SubeCard subeCard) throws InvalidSubeCardException, InvalidUserException;
	public Integer deleteUser(User user) throws InvalidUserException;
